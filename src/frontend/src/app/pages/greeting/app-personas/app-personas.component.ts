...
export class AppPersonasComponent {
  ...
  async getPeople() {
    ...
    const mockData = [
      { id: 1, nombre: 'Juan', f_nacimiento: 'ejemplo@ejemplo.cl', ciudad: '9 1234 5678', avatar: 'Condominio A' },
      { id: 2, nombre: 'Ana', f_nacimiento: 'ejemplo@ejemplo.cl', ciudad: '9 1234 5678', avatar: 'Condominio B' },
    ];
